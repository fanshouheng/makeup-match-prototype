...
7. 激活后显示 3 次体验额度和 180 天有效期；会员页能从当前浏览器 IndexedDB 恢复最近一次有效分析和真实生成成功的报告。网站数据库和 Storage 中没有密码明文、普通用户照片、付款凭证或微信聊天；Plus 任务可按第 12 节边界临时保存比例、配置和报告。
