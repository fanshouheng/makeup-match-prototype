...
- 分享率：`首次成功分享会话 / 结果展示会话`。
- Plus 价格实验：按 9.9 元、19.9 元、29.9 元分别查看曝光、展开、配置完成、愿意购买、价格偏高和暂不需要；购买意向率为 `愿意购买 / 对应价格曝光`。
...
Plus 三种意向反馈合计每个会话最多记录一次。每档未满 300 次曝光时只积累样本；满 300 次后，低于 1% 停止真实开发，1% 至 3% 重新检查价值表达，高于 3% 进入最小版本，高于 5% 才准备真实支付。Plus 统计不包含场景、妆造方向、联系方式或支付资料。
