...
const BANNED_REPORT_TEXT =
  /(?:瞎|失明|残疾|残障|畸形|智障|弱智|猥琐|丑陋|性能力|娘炮|种族|民族|疾病|看不见|什么也看不见|算计|心眼|气量|刻薄相|精明|不好糊弄|不好惹|不吃亏|没底气|不大气|小家子气|刁钻|凉薄|薄情|阴险|奸诈|老实|聪明|机灵|凶相|凶狠|凶恶|温柔|和善|善良|自信|怯懦|胆小|睁开费劲|斜视|斗鸡眼|裂口女|脱臼|血印|后娘养的)/i;
