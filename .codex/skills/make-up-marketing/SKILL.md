...
当任务涉及内容选题、脚本、开头、画面设计或内容复盘时，再读取 `references/content-editorial.md`。产品证据决定内容使命和 CTA，编导方法只负责把它表达清楚；不得用表达技巧覆盖未知项。涉及平台算法、流量、发布时段、内容体裁或违规判断时，只采用带日期的当前官方资料与账号后台证据。
