...
2. 等待照片质量检查和面部比例分析。
3. 查看与你面部结构更接近的博主。
4. 无需登录，直接选择“符合”或“不太符合”，也可以分享当前结果。
5. 打开博主主页或代表教程，寻找适合自己的妆容参考。
...
分享图包含用户所选照片、首选博主照片和返回 LOOK AI 首页的二维码；本站不会保存分享内容。

为评估识别完成率、结果符合率和分享率，应用会按匿名浏览器会话记录选择照片、识别结果、反馈和首次成功分享。记录不包含照片、面部比例、匹配分数、博主名称或排序。
