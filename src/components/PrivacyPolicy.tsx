    ...
    <main className="privacy-page">
      ...
      <section className="privacy-section">
        ...
        <div>
          ...
          <p>
            AI 推荐每个 IP 每小时最多请求 3 次。限流只保存经过加盐单向哈希的 IP 标识，不保存原始 IP。为排查服务稳定性，LOOK AI 只记录调用时间、成功或失败、耗时、固定错误分类和所选参考模式；不记录照片、面部比例、提示词、AI 返回名字、推荐结果或原始 IP。关闭 AI 推荐不会影响默认本地匹配。
          </p>
        </div>
      </section>
