    ...
    <main className="privacy-page">
      ...
      <section className="privacy-section">
        ...
        <div>
          ...
          <p>
            为评估访问到匹配的完整漏斗，应用会记录进入产品、选择照片、分析成功或失败、结果展示、你主动选择的“符合/不太符合”、点击任一创作者链接和首次成功分享。Supabase 只接收当前标签页会话的随机标识和固定事件名称；Vercel Analytics 记录聚合访问、预定义渠道编号以及不含创作者身份的链接类型。两者都不会收到照片、面部比例、匹配分数、创作者名称、具体链接或完整排序。关闭标签页后，随机会话标识不会继续用于后续会话；分享图片只在本机生成，本站不会保存分享内容。
          </p>
        </div>
      </section>
